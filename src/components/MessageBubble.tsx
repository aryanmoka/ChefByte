...
const MessageBubble: React.FC<MessageBubbleProps> = ({ message }) => {
  ...
  const aiBubble = 'bg-white dark:bg-gray-700 text-gray-900 dark:text-white border border-gray-200 dark:border-gray-600 rounded-bl-sm';
  ...
  return (
    ...
    >
      <div
        className={`flex items-start gap-3 ${isUser ? 'flex-row-reverse' : 'flex-row'} max-w-[90%] sm:max-w-[75%] md:max-w-[65%] lg:max-w-2xl`}
      >
        {/* Avatar */}
